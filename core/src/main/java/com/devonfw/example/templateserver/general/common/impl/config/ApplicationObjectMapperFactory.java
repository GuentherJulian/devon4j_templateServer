package com.devonfw.example.templateserver.general.common.impl.config;
...
/**
 * The MappingFactory class to resolve polymorphic conflicts within the templateserver application.
 */
